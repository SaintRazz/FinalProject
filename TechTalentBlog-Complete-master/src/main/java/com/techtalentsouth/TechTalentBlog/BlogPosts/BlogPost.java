...
public class BlogPost {
    ...
    public BlogPost(String title, String author, String blogEntry, String status) {
        this.title = title; 
        this.author = author;
    ...
    public String toString() {
        return "BlogPost [id=" + id + ", title=" + title + ", author=" + author + ", blogEntry=" + blogEntry + ", status=" + status + "]";
    }
}
